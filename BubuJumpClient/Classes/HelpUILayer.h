...
{
public:
    HelpUILayer() : _pageNode1(nullptr), _pageNode2(nullptr), _pageNode3(nullptr), _pageNode4(nullptr), _pageNode5(nullptr), _lotteryNode(nullptr), _leftArrowButton(nullptr), _rightArrowButton(nullptr), _nameEditBox(nullptr), _phoneEditBox(nullptr), _currentPageIndex(0) {};
    virtual ~HelpUILayer();
